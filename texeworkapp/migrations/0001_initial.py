# Generated by Django 4.0.2 on 2024-01-09 13:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('joindate', models.DateField(default=datetime.date(2024, 1, 9), null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start_time', models.DateTimeField(blank=True, default=datetime.datetime(2024, 1, 9, 18, 37, 43, 96240), null=True)),
