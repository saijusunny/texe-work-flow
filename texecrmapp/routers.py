class App1Router(object):
    ...
    def db_for_read(self, model, **hints):
        ...
        if model._meta.app_label == 'texecrmapp':
            return 'form1_db'
        return None
    ...
    def allow_relation(self, obj1, obj2, **hints):
        ...
        if obj1._meta.app_label == 'texecrmapp' and obj2._meta.app_label == 'texecrmapp':
            return True
        # No opinion if neither object is in the Example app (defer to default or other routers).
        elif 'texecrmapp' not in [obj1._meta.app_label, obj2._meta.app_label]:
            return None
